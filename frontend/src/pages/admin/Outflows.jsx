      ...
      <div className="p-4">
        ...
        <div className="flex gap-3 mt-4">
          <button
            ...
            className="h-[40px] w-[90px] cursor-pointer font-primary font-medium bg-blue-600 hover:bg-blue-700 text-white rounded-md transition"
          >
            Filter
          </button>
          <button
            onClick={handleResetFilters}
            className="h-[40px] w-[90px] cursor-pointer font-primary font-medium bg-gray-200 hover:bg-gray-300 text-black rounded-md transition"
          >
            Reset
          </button>
        </div>
