      ...
      <aside className={` overflow-hidden  ${isCollapsed ? 'w-[80px]' : 'w-[300px]'} h-screen sticky top-0  bg-white `}>
        <div className="flex items-center justify-center my-6 ">
          ...
          <h4 className="font-primary font-bold text-xl">
            {
              isCollapsed ? <h3 className="mb-1 font-secondary text-2xl text-blue-700 font-semibold ">X</h3> : 
              <div>
                <a href='/admin/dashboard' className="mb-1 font-secondary text-2xl text-blue-700 font-semibold ">InventaX</a>
        ...
        <div className="px-5 py-4 h-full flex flex-col space-y-3 font-secondary text-gray-500">
          ...
          <button onClick={handleLogout} className="flex items-center gap-2.5 self-start text-red-500 cursor-pointer hover:bg-red-50 w-full transition-all duration-100 ease-in  px-2 py-2 rounded-lg ">
            <span>
              <IoIosLogOut />
            </span>
            {
              isCollapsed ? <IoIosLogOut /> : 'Logout'
            }
          </button>
