...
const handleGetAllInvoices = async (req, res) => {
    try {
        ...
        const totalInvoices = await Invoice.countDocuments({ tenantId:userId })
        ...
        console.log("these are all invoices...",invoices)
...
const handleUpdateInvoice = async (req, res) => {
    try {
        ...
        console.log("this is productId in handle update product",product[0].productId)


        const invoice = await Invoice.findOne({ _id : id, tenantId:userId  });
      ...
      <body>
        ...
        <div class="header">
          <div class="logo-block">
            <div>
              <div class="logo-box">InventaX</div>
